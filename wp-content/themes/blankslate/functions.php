...
function sho_add_to_cart_fragment( $fragments ) {

	$fragments[ '.sho-cart' ] = '<a href="' . wc_get_cart_url() . '" class="sho-cart">Cart (' . WC()->cart->get_cart_contents_count() . ')</a>';
 	return $fragments;
     /* a href="<?php echo wc_get_cart_url() ?>" class="sho-cart">Basket (<?php echo WC()->cart->get_cart_contents_count() ?>)</a> */
