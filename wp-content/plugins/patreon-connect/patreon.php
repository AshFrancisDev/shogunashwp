...
define( "PATREON_TEXT_OVER_BUTTON_1", 'To view this content, you must be a member of <b><a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a> at $%%pledgelevel%%</b> or more' );
define( "PATREON_TEXT_OVER_BUTTON_1A", 'To view this content, you must upgrade your tier to <b>$%%pledgelevel%% or higher at <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a></b>. Upgrade below to unlock this content.' );
define( "PATREON_TEXT_OVER_BUTTON_2", 'Edit your pledge to Shogun Ash to $%%pledgelevel%% or more to access this content. You\'re currently pledging $%%currentpledgelevel%%.' );
...
define( "PATREON_VALID_PATRON_POST_FOOTER_TEXT", 'This content is available exclusively to members of <b><a href="%%creator_link%%" target="_blank">ShogunAsh Patreon</a> at $%%pledgelevel%%</b> or more.' );
...
define( "PATREON_WORDPRESS_VERSION", '1.8.3' );
...
define( "PATREON_TEXT_OVER_BUTTON_7", 'This content is available exclusively to members of <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a> at the time of posting. <b><a href="%%flow_link%%" rel="nofollow">Become a patron at $%%pledgelevel%% or more</a></b> to get exclusive content like this in the future.' );
define( "PATREON_TEXT_OVER_BUTTON_8", 'This content is available exclusively to members of <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a> at the time of posting.  Your account does not fulfill the requirements. Become a patron to get exclusive content like this in the future.' );
define( "PATREON_TEXT_OVER_BUTTON_9", 'This content is available exclusively to members of <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a> at %%tier_level%% or higher tier, or having at least $%%total_pledge%% pledged in total. Upgrade below to unlock this content.' );
define( "PATREON_TEXT_OVER_BUTTON_10", 'This content is available exclusively to members of <b><a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a></b> <b>at %%tier_level%%</b> or higher tier at the time this content was posted, or having at least $%%total_pledge%% pledged in total.' );
define( "PATREON_TEXT_OVER_BUTTON_11", 'This content is available exclusively to members <b>at %%tier_level%%</b> or higher tier <b>at <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a></b> at the time this content was posted.' );
define( "PATREON_TEXT_OVER_BUTTON_12", 'This content is available exclusively to members of <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a> at %%tier_level%% or higher tier, or having at least $%%total_pledge%% pledged in total.' );
define( "PATREON_TEXT_OVER_BUTTON_13", 'This content is available exclusively to members of <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a> at %%tier_level%% or higher tier at the time this content was posted, or having at least $%%total_pledge%% pledged in total.' );
define( "PATREON_TEXT_OVER_BUTTON_14", 'This content is available exclusively to members of <a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a> at %%tier_level%% or higher tier at the time this content was posted, or having at least $%%total_pledge%% pledged in total. Your account currently does not qualify.' );
define( "PATREON_TEXT_OVER_BUTTON_15", 'To view this content, you must be a member of <b><a href="%%creator_link%%" target="_blank">Shogun Ash Patreon</a></b>' );
